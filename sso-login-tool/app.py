...
import config
from authenticator import Authenticator, AuthResponseError
from browser import Terminated
...
def run_openconnect(auth_info, host, proxy, version, run, args):
    ...
    if run:
        ...
        print("Session Token: ", session_token.decode("utf-8"))
        return 0
